...
// query
const { fetchIssueId, fetchLabelId } = __nccwpck_require__(653);

// mutate
const { createBranch } = __nccwpck_require__(343);
const { createPullRequest } = __nccwpck_require__(917);
const { labelIssue } = __nccwpck_require__(184);
const { addComment } = __nccwpck_require__(65);
